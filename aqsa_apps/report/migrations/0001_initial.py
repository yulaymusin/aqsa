...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sum_of_values', models.DecimalField(db_index=True, decimal_places=2, max_digits=20, null=True, verbose_name='Sum Of "Values" (in currency of wallets) of Transactions')),
                ('sum_of_values_in_curr', models.DecimalField(db_index=True, decimal_places=2, max_digits=20, null=True, verbose_name='Sum Of "Values in currency" of Transactions')),
                ('category_null', models.BooleanField(default=False)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='wallet_tag_etc.Category', verbose_name='Category')),
                ('report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='data', to='report.Report')),
            ],
            options={
